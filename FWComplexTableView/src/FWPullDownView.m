...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _textLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, frame.size.height - 30, frame.size.width, 30)];
...
- (void)setFrame:(CGRect)frame{
    ...
    [_textLabel setFrame:CGRectMake(0, frame.size.height - 30, frame.size.width, 30)];
